    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="browse.php" role="button" data-bs-toggle="dropdown"
            aria-expanded="false">
            Browse
          </a>
      ...
      <form class="d-flex" method="POST" action="browse.php" role="search">
        <input class="form-control me-2" name="part_searched" type="search" placeholder="Search" aria-label="Search">
